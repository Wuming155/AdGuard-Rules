...
| 规则文件 | 说明 | 规则数量 | 下载链接 |
| :--- | :--- | :--- | :--- |
| adguard_rules.txt | AdGuard DNS 格式完整规则集，适用于 AGHForRoot / AdGuard Home | 1086810 | [点击下载](https://github.com/Wuming155/AdGuard-Rules/releases/latest/download/adguard_rules.txt) |
...
| adguard_lite.txt | AdGuard 格式精简版（仅广告过滤） | 217857 | [点击下载](https://github.com/Wuming155/AdGuard-Rules/releases/latest/download/adguard_lite.txt) |
